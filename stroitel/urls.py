...
from news.views import NewsListView, GuideListView, InitiativesListView, DocsListView, VotingsListView
...
urlpatterns = [
    ...
    path('votings/', VotingsListView.as_view(), name='votings_list'),
